...
namespace GC.Forms.Main.Modals.Requests.SubModals.NewRequest
{
    public partial class FRM_EditDiscounts : Bases.FRM_Default
    {
        ...
        internal FRM_EditDiscounts(List<double> values, List<double> percents)
        {
            InitializeComponent();
        ...
        private void RbtValue_CheckedChanged(object sender, EventArgs e)
        {
            ...
            nudValue.Maximum = 9999999;
            nudValue.Minimum = Convert.ToDecimal(0.01);
        }
        ...
        private void RbtPercent_CheckedChanged(object sender, EventArgs e)
        {
            ...
            nudValue.Maximum = 999999;
            nudValue.Minimum = Convert.ToDecimal(0.00001);
        }
